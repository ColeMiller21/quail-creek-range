...
export const metadata: Metadata = {
  ...
  keywords: "directions, location, Quail Creek Range, Northlake TX, Texas Motor Speedway, Exit 74, I35W",
}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12">
              <p className="text-xl md:text-2xl text-foreground text-center leading-relaxed">
                Quail Creek Range is located 2 miles north of the Texas Motor Speedway on I35 West (Exit 74 on I35W same
                side as TMS).
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="space-y-8">
                <div className="bg-card rounded-lg p-6 shadow-lg">
                  <h2 className="text-2xl font-serif font-semibold mb-4 text-foreground">Driving Directions</h2>
                  <p className="text-lg leading-relaxed text-muted-foreground">
                    After crossing over I-35, you will come to a gravel road...keep going. Quail Creek Range is 300 ft.
                    further on your right.
                  </p>
                </div>

                <div className="bg-card rounded-lg p-6 shadow-lg">
                  <h3 className="text-xl font-serif font-semibold mb-3 text-foreground">Address</h3>
                  <address className="not-italic space-y-1 text-muted-foreground">
                    <p className="text-lg font-semibold text-foreground">Quail Creek Range</p>
                    <p>13814 FM 1171</p>
