...
export const metadata: Metadata = {
  ...
  keywords: "contact Quail Creek Range, shooting range contact, Northlake Texas contact, range inquiries",
}
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center pt-32">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
            Have questions about our ranges, training programs, or services? We're here to help.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-700 delay-150">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">Tuesday - Sunday: 8:00 AM - 6:00 PM</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">Serving the greater DFW area</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Hours Card */}
              <div className="bg-card border border-border rounded-lg p-6 shadow-sm">
                <h3 className="font-serif text-xl font-semibold text-primary mb-4">Hours of Operation</h3>
