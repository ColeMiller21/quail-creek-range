          ...
          <Card className="p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Click on the link below to view the Participant Agreement form.
                Fill out the form, print it, and bring it with you to the Range
                to save time on check-in.
              </p>
            </div>
            ...
            <div className="mt-8 p-4 bg-accent/10 border border-accent/20 rounded-lg">
              <p className="text-sm text-foreground">
                <strong>Note:</strong> All participants must complete this form.
                For participants under 18 years of age, a parent or guardian
                must complete the additional indemnification section.
              </p>
            </div>
          </Card>
        </div>
