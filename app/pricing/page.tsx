        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
              <h2 className="font-serif text-3xl font-semibold text-primary mb-6 text-center">Standard Rates</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="border-2 hover:border-accent transition-colors">
                  ...
                  <CardContent>
                    <div className="text-4xl font-bold text-accent mb-2">$22.00</div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 hover:border-accent transition-colors">
                  ...
                  <CardContent>
                    <div className="text-4xl font-bold text-accent mb-2">$17.00</div>
                  </CardContent>
                </Card>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
              <h2 className="font-serif text-3xl font-semibold text-primary mb-6 text-center">Discount Cards</h2>
              <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                <Card className="border-2 hover:border-primary transition-colors">
                  ...
                  <CardContent>
                    <div className="text-4xl font-bold text-accent mb-4">$100.00</div>
                ...
                <Card className="border-2 hover:border-primary transition-colors">
                  ...
                  <CardContent>
                    <div className="text-4xl font-bold text-accent mb-4">$200.00</div>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm text-muted-foreground">
                        <Check className="w-4 h-4 text-primary" />
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-450">
              <h2 className="font-serif text-3xl font-semibold text-primary mb-6 text-center">Senior Discount Cards</h2>
              <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                <Card className="border-2 hover:border-primary transition-colors">
                  <CardHeader>
                    <CardTitle className="text-2xl">5 Range Fees</CardTitle>
                  ...
                  <CardContent>
                    <div className="text-4xl font-bold text-accent mb-4">$95.00</div>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm text-muted-foreground">
                        <Check className="w-4 h-4 text-primary" />
                        <span>5 visits to the range</span>
                ...
                <Card className="border-2 hover:border-primary transition-colors">
                  ...
                  <CardContent>
                    <div className="text-4xl font-bold text-accent mb-4">$180.00</div>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm text-muted-foreground">
                        <Check className="w-4 h-4 text-primary" />
                        <span>10 visits to the range</span>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-600">
              <div className="bg-primary/10 border-2 border-primary rounded-lg p-8 text-center">
                <h2 className="font-serif text-3xl font-semibold text-primary mb-4">Service Discounts with ID Card</h2>
                ...
                <p className="text-lg text-foreground mb-6 max-w-3xl mx-auto text-balance">
                  Active Duty Military, Retired Military, First Responders, Law Enforcement, Seniors (65+)
                </p>
                <div className="bg-background/50 rounded-lg p-4 max-w-2xl mx-auto">
                  <p className="text-sm text-muted-foreground italic">
                    Use of Police Range when available for Law Enforcement Officer only.
                  </p>
                </div>
              </div>
            </div>
