...
export default function Navigation() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex items-center justify-center gap-8 py-4">
              {navLinks.map((link) => (
                <div
                  ...
                  onMouseEnter={() =>
                    link.submenu && setOpenDropdown(link.label)
                  }
          ...
          <div className="lg:hidden flex items-center justify-between h-20">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span
                className={`font-serif font-semibold text-xl ${getTextColor()} transition-colors duration-300`}
              >
                Quail Creek Range
              </span>
            </Link>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-20 bottom-0 z-40 bg-background overflow-y-auto animate-in fade-in slide-in-from-top-4 duration-300">
